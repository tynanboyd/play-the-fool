 ...
 *
 * This task does the following:
 *     1. Gets the source of fonts raw folder
 *     2. Moves them to the public folder
 *
 */
gulp.task('fonts', () => gulp
  .src(config.fontSRC)
  .pipe(gulp.dest(config.fontDST))
  .pipe(notify({ message: '\n\n✅ TASK: "fonts" completed\n', onLast: true })));
...
gulp.task(
  'default',
  gulp.parallel('styles', 'vendorsJS', 'customJS', 'images', 'fonts', browsersync, () => {
